...
<div class="grid md:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-gradient-to-br from-gray-400 to-gray-600 rounded-lg shadow-lg p-6 text-white">
        <div class="flex justify-between items-start">
            <div>
                <p class="text-gray-100 text-sm font-semibold">Total Laporan</p>
    ...
    <a href="{{ route('pengaduan.create') }}"
       class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition">
        <div class="flex items-center space-x-4">
            <div class="bg-gray-100 w-14 h-14 rounded-full flex items-center justify-center">
            ...
            <div class="border border-gray-200 rounded-lg p-4 hover:border-gray-300 transition">
                ...
                <div class="flex justify-between items-center mt-3 pt-3 border-t border-gray-100">
                    ...
                    <a href="{{ route('pengaduan.show', $item) }}"
                       class="text-gray-600 hover:text-gray-800 font-semibold text-sm whitespace-nowrap">
