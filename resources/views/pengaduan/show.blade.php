...
@section('content')
    ...
    <div class="detail-wrapper">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ auth()->user()->isPetugas() ? route('petugas.dashboard') : route('dashboard') }}" class="back-button">
            ...
            <div class="md:col-span-2 space-y-6 main-content-section">
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div id="mapContainer" class="map-container-responsive bg-gray-50">
                            ...
                            <div id="mapFallback" class="hidden p-4">
                                <p class="text-gray-600 text-sm">Koordinat lokasi tidak tersedia. Tidak dapat menampilkan
                                    peta.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <p
                            class="description-text text-gray-700 leading-relaxed break-words overflow-hidden whitespace-pre-line">
                            {{ $pengaduan->deskripsi }}
                        </p>
                    </div>
                            ...
                            <div class="photo-grid">
                                @foreach ($pengaduan->foto as $foto)
                                    <a href="{{ Storage::url($foto->file_path) }}" target="_blank" class="group">
                                        <img src="{{ Storage::url($foto->file_path) }}" alt="Bukti" class="photo-item">
                                    </a>
                                @endforeach
                            </div>
                        </div>
...
@if ($pengaduan->canGiveFeedback() && !$pengaduan->rating)
    <div id="feedbackModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black bg-opacity-50 p-4">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('pengaduan.feedback', $pengaduan) }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="feedback" rows="4" required class="w-full border rounded px-3 py-2 text-sm"
