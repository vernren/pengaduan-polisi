    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-8">
            <h2 class="text-2xl font-bold text-center mb-6 text-gray-800">
                <i class="fas fa-user-plus text-gray-600 mr-2"></i>Daftar Akun Baru
            </h2>
            ...
            <form action="{{ route('register') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex">
                        ...
                        <input type="text" id="phone_input" value="{{ old('phone') ? ltrim(old('phone'), '+62') : '' }}"
                            required
                            class="w-full px-4 py-2 border border-gray-300 rounded-r-lg focus:outline-none focus:ring-2 focus:ring-gray-600"
                ...
                <div class="mb-4">
                    ...
                    <input type="file" id="foto_identitas" name="foto_identitas" accept="image/*" capture="environment" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-600 bg-white">
                ...
                <button type="submit"
                    class="w-full bg-gray-800 text-white py-3 rounded-lg hover:opacity-90 transition font-semibold">
            ...
            <p class="text-center mt-6 text-gray-600">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="text-yellow-400 hover:text-yellow-600 font-semibold">Masuk di sini</a>
            </p>
        </div>
    </div>
@endsection